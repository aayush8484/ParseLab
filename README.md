...
**ParseLab** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
1.  Extensive gudie to using the parse backend.
...
I had difficulty receiving data uisng the Parse backend initially. However, I managed to make it work.
